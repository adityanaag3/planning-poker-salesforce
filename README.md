...
<ol>
    <li>
        Click the button below to install on Developer Edition, Trailhead Playgroud or Production orgs<br/>
            <p>
                <a href="https://login.salesforce.com/packaging/installPackage.apexp?p0=04t0o000003jP23AAE">
    ...
    <li>
        Click the button below to install on Sandboxes or Scratch Orgs<br/>
            <p>
                <a href="https://test.salesforce.com/packaging/installPackage.apexp?p0=04t0o000003jP23AAE">
